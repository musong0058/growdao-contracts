...
const providers = {
  basegoerli: new ethers.providers.JsonRpcProvider(BASE_GOERLI_URL),
  rolluxtest: new ethers.providers.JsonRpcProvider(ROLLUX_TESTNET_URL),
};

const signers = {
  basegoerli: new ethers.Wallet(BASE_GOERLI_DEPLOY_KEY).connect(providers.basegoerli),
